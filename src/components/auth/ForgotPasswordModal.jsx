    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          >
            {/* soft glow layer like AddProperty modal */}
            <div
              aria-hidden="true"
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      <button
                        type="submit"
                        disabled={loading}
                        className="flex-1 inline-flex items-center justify-center gap-2 bg-operon-blue text-white px-4 py-2 rounded-lg hover:bg-blue-400 disabled:opacity-60 disabled:cursor-not-allowed transition"
                      >
                        {loading && (
